    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
           ...
           <div class="row">
                 ...
                 <div class="col-3">
                     <span>Position:</span> <input type="text" name="initial_position_update" id="initial_position_update" class="form-control">
                 </div>
                 <div class="col-3">
           ...
           <div class="row">
                ...
                <div class="col-4">
                    ...
                    <input type="date" name="date_hired" id="initial_training_date_update" class="form-control">
                </div>
