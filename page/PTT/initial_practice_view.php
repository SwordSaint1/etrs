          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <table>
                  <tr>
                  <th><label>Batch  No:</label><input type="text" name="batch_no"  id="batch_no_initial_practice_view" class="form-control"></th>
                    <th></th>
                  <th><label>Employee No:</label><input type="text" name="employee_num_initial" id="employee_num_initial_practice_view"  class="form-control"></th>
                    <th></th>
                  <th><label>Full Name:</label><input type="text" name="full_name_initial" id="full_name_initial_practice_view"  class="form-control"></th>
                  <th><label>Process:</label><input type="text" name="eprocess_initial_view" id="eprocess_initial_practice_view"  class="form-control"></th>
                  </tr>
                </table>
                  </div>
                </h3> 
